#line 1 "/home/james/Documents/dRehmFlight/Versions/dRehmFlight_rip_rewrite/src/Eigen/ArduinoEigen/Eigen/src/SparseCore/SparseMatrix.h"
...
EIGEN_DONT_INLINE typename SparseMatrix<_Scalar,_Options,_StorageIndex>::Scalar& SparseMatrix<_Scalar,_Options,_StorageIndex>::insertCompressed(Index row, Index col)
{
  ...
  if (m_data.allocatedSize()<=m_data.size())
  {
    ...
    else
    {
      ...
      reallocRatio = (std::min)((std::max)(reallocRatio,(double)1.5),(double)8.);
    }
  }
