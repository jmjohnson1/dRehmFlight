function plotFlightData(filename)
    ...
    figure(5);
    hold on
    plot(kp_roll, DisplayName="K_p_{roll}")
    plot(ki_roll, DisplayName="K_i_{roll}")
    plot(kd_roll, DisplayName="K_d_{roll}")
    plot(kp_pitch, DisplayName="K_p_{pitch}")
    plot(ki_pitch, DisplayName="K_i_{pitch}")
    plot(kd_pitch, DisplayName="K_d_{pitch}")
    hold off
    legend();
    grid on
    title("Gains")
